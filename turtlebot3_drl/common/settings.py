...
REAL_LIDAR_CORRECTION       = 0.0  # meters, subtracted from the real LiDAR values
...
REAL_THRESHOLD_GOAL         = 0.15  # meters, minimum distance to goal that counts as reaching the goal
